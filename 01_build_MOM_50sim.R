...
saveRDS(MOM, file = "MOM/MOM_BUM_50sim.rds")
#saveRDS(multiHist, file = "MOM/multiHist_BUM_50sim.rds")
...
MOM <- SS2MOM(replist, nsim = nsim)
#multiHist <- multiMSE(MOM, Hist = TRUE, checkMPs = FALSE, parallel = FALSE)
saveRDS(MOM, file = "MOM/MOM_WHM_50sim.rds")
#saveRDS(multiHist, file = "MOM/multiHist_WHM_50sim.rds")
...
MOM <- SS2MOM(replist, nsim = nsim)
#multiHist <- multiMSE(MOM, Hist = TRUE, checkMPs = FALSE, parallel = FALSE)
saveRDS(MOM, file = "MOM/MOM_SMA_50sim.rds")
#saveRDS(multiHist, file = "MOM/multiHist_SMA_50sim.rds")
...
#multiHist <- multiMSE(MOM, Hist = TRUE, checkMPs = FALSE, parallel = FALSE)
saveRDS(MOM, file = "MOM/MOM_BSH_50sim.rds")
#saveRDS(multiHist, file = "MOM/multiHist_BSH_50sim.rds")
...
MOM <- SS2MOM(replist, nsim = nsim)
#multiHist <- multiMSE(MOM, Hist = TRUE, checkMPs = FALSE, parallel = FALSE)
saveRDS(MOM, file = "MOM/MOM_SWO_50sim.rds")
#saveRDS(multiHist, file = "MOM/multiHist_SWO_50sim.rds")
...
MOM <- SS2MOM(replist, nsim = nsim)
#multiHist <- multiMSE(MOM, Hist = TRUE, checkMPs = FALSE, parallel = FALSE)
saveRDS(MOM, file = "MOM/MOM_BET_50sim.rds")
#saveRDS(multiHist, file = "MOM/multiHist_BET_50sim.rds")
