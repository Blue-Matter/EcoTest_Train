...
SS_2_XL = function(io, Fnam = c("F4_JPN_LL","F8_ESP_LL"), Inam = c("S2_JPN_LATE","S4_EU_ESP"),
  ...
  if(lengthswitch){
    ...
    if(!("year" %in% names(dat$lencomp)))names(dat$lencomp)[1] = "year"
