...
Stoch_effort3 = function(ny=75, plot=F, nstocks = 3, Ecor = 0.6){
  ...
  fracs = 0.05+runif(3)
  fracs/mean(fracs)
  effsi = effsi*array(rep(fracs,each=nrow(effsi)),dim(effsi))
...
cat("Effort simulator code for Indicator 3 loaded \n")
